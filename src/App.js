...
const API_KEY = "api_key=20d58f5b3c26571a905c7392c8f4ced9";
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-7">
                        <Video title={this.state.currentMovie.title} videoId={this.state.currentMovie.videoId}/>
                        <VideoDetail title={this.state.currentMovie.title} description={this.state.currentMovie.overview}/>
                    </div>
                    <div className="col-md-5">
                        <div className="sousTitre">
                            <p>Cliquez sur une recommandation</p>
                        </div>
                        {renderVideoList()}
                    </div>
                </div>
